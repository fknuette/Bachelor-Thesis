...
if __name__ == '__main__':
    ...
    trlog_path = f"/pfs/work7/workspace/scratch/ma_fknuette-project_GRANDE/1_jovita/cifar10/execute/results_model/{objective}-grande/{args.model}/trlog"
    ...
    json_path = f"/pfs/work7/workspace/scratch/ma_fknuette-project_GRANDE/1_jovita/cifar10/single/clean/info.json"
